...
def run_firefly1():
    ...
    config_filestring = dir + '2-28-2017 20x150  config.json'
    networkconfig_filestring = dir + '2-28-2017 20x150  networkconfig 2.json'
    inputcurrents_filestring = dir + '2-28-2017 inputs.json'
    results_postfix = ' simulations 2.json'
    ...
    for i_gen in range(0, N_gen):
        ...
        for i_fly in range(0, N_bugs):
            oneGen[i_fly] = {'noise': np.copy(noiseTerms[i_fly, :]).tolist(),
                             ...
                             'gen': i_gen, 'fly': i_fly,
                             'updateCounts': updateCounts}  # ,'paretoIDs':paretoIDs,'cullIDs':cullIDs}
