...
logrand_sigma = 1.5  # would be interesting at some point to leave these out and examine this continuum computationally
...
# save in json format
saveName = target_dir + config_prefix + ' networkconfig 3.json'
